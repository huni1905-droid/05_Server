...
<body>
	...
	- 기본 작성법 : \${key} (실제 사용 시 백슬래스는 제거하고 사용)
	
	</pre>
	
	<h3>전달 받은 파람비터를 출력하는 방법</h3>
	<p>주소 뒤에 쿼리스트링(?name=홍길동&age=20) 직접 작성하여 태스트</p>
	...
	<p style="color:red">
		JSP 표현식에서 없는 파라미터(데이터)를 얻어오면 null 로 출력됨
	</p>
	...
	<div>
		<%-- EL에서 파라미터의 값 얻어오는 방법 ${param.key값} 
			...
			- get 이라는 단어 사용하지 않음
		--%>
		name : ${param.name} <!-- Parameter에서 name 값을 갖고온다 -->
		<br>
		age : ${param.age} 
	</div>
