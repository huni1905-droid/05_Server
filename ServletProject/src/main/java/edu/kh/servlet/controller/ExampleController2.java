...
// 상속 받았다고해서 바로 Servlet 등록이 되는것은 아님!
// -> 방법1. web.xml 작성하기
 ...
 *  <servlet> <servlet_mapping> 를 작성하는 효과
 * 
 * */
@WebServlet("/signUp")
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		// 손님(클라이언트) -> 웨이터(Servlet) -> 중간알바생(dispatcher) ->  주방장(JSP)
		//											(req, resp 들고)	(주방장이 있는 위치 : "/WEB-INF/views/result.jsp")	
		// RequestDispatcher 는 req에서 꺼내온다
		//														경로 작성 기준 : webapp 폴더 기준으로 작성!
		//														"webapp 폴더 하위에" WEB-INF 하위에 views 하위에 result에 작성
