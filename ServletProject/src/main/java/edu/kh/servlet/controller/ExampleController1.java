...
public class ExampleController1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		// Parameter(요청시 제출된 데이터) : 매개변수 == 다른 곳의 값을 전달받아 올 때 사용
		...
		// 2) 응답받은 내용(HTML 코드)을 클라이언트의 브라우저가 
		// 		해석하여 화면에 출력해줌
		...
		sb.append("</html>");
		// 매우 복잡 -> Servlet은 응답페이지 생성을 잘 못함!
		// -> 응답페이지를 잘 만들어주는 JSP에게 위임(다음에 할때는)
